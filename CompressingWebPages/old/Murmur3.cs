...
{
	/* TAKEN FROM: http://blog.teamleadnet.com/2012/08/murmurhash3-ultra-fast-hash-algorithm.html */
	...
	public static class IntHelpers
	{
		...
		#region GetUInt64
		/* Faster implementation of BitConverter.ToUInt64(bb, pos); but it is unsafe!
